...
global.called = false
global.Prefix = 'Multi'
global.ownerNumber = '6282232793235'
global.botName = 'MazBot - MD' 
global.owner = ['6282232793235', '6285858155832','62895710073737','62895710073737'] 
global.ownerName = 'Own-MalvinZ√'
global.packName = 'AlvinZ' 
global.author = 'AlvinDavi✓'
global.sessionName = 'MalvinZQr'
...
module.exports = Manik = async (Manik, m, mentioned, chatUpdate, store) => {
	...
	const fgclink = {key: {participant: "0@s.whatsapp.net","remoteJid": "0@s.whatsapp.net"},"message": {"groupInviteMessage": {"groupJid": "6283102650464-1589321480@g.us","inviteCode": "m","groupName": "MazBot - Md", "caption": `©MalvinZ`, 'jpegThumbnail': global.thumb}}}
...
const reply2 = (teks) => {
Manik.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botName}`,"body": `MazBot - Md Group`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./media/Manik.jpg`),"sourceUrl": "https://chat.whatsapp.com/IB8ASUJkb1g0ccK3DkDpTJ"}}}, { quoted: m, contextInfo: { externalAdReply: {
...
const reply1 = (teks) => {
Manik.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botName}`,"body": `Follow Instagram MalvinZ`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./media/Manik.jpg`),"sourceUrl": "https://instagram.com/alvindavi_"}}}, { quoted: m})
}
...
const buttonsDefault = [
			{ callButton: { displayText: `Call Owner!`, phoneNumber: `+6282232793235` } },
			{ urlButton: { displayText: `Instagram Owner`, url : `https://instagram.com/alvindavi_` } },
 ...
 *｢  BOT MENU  ｣*  	
 ...
 © DESIGN: MALVINZ`
 Manik.sendMessage(m.chat, { caption: anu, image: { url: resImage }, templateButtons: buttonsDefault, footer: 'MazBot By Own-MalvinZ✓', mentions: [m.sender] })
break 
}
 ...
 *｢ JASA SUNTIK SOSMED ｣*
 ...
 © DESIGN: ARYAMANIK`
 Manik.sendMessage(m.chat, { caption: anu, image: { url: resImage }, templateButtons: buttonsFirst, footer: 'MazBot By Own-MalvinZ✓', mentions: [m.sender] })
break 
}
case prefix+'jaksel':
...
let noshp = text
if (isNaN(parseInt(noshp))) return reply(`${command} 6282232793235`)
const sections = [
    {
...
_For Your Information, MazBot Hanya Mendukung Deposit Melalui Ovo, Gopay, Dana, Qris Saja._

_》Ovo : 081235327791_
_》Gopay : 082232793235_
_》Dana : 081235327791_
_》Qris : Chat Owner_
...
_Contoh:_
${prefix}bukti 10000|isi Saldo 6282232793235
...
let encmedia = await Manik.sendImage(`6282232793235@s.whatsapp.net`, media, `Bukti Dari: ${sender.replace("@s.whatsapp.net", "")}`, m)
let buttons = [
...
Manik.sendButtonText(`6282232793235@s.whatsapp.net`, buttons, `${bukti}`, Manik.user.name, m)
}
break
case prefix+'depoyes':
if (!isManik) return reply(mess.owner)
...
Manik.sendButtonText(`${siapah}`, nbuttons, `Topup Anda Berhasil Di Acc, Silahkan Melakukan TopUp Dengan Mudah Hanya Di MazBot!`, Manik.user.name, m)
break
case prefix+'depono':
if (!isManik) return reply(mess.owner)
                ...
                for (let i of anu) {
                    ...
                    let btn = [{
                                urlButton: {
                                    ...
                                    url: 'https://chat.whatsapp.com/IB8ASUJkb1g0ccK3DkDpTJ'
                                }
                            }, {
                                quickReplyButton: {
                                    displayText: 'Owner',
...
🔗 *Media Url* : ${images}`,
	    ...
	    if (!text) return m.reply(`Example : ${command} story wa anime`)
                ...
                let buttons = [
                	{ urlButton: { displayText: `𝐒𝐮𝐩𝐩𝐨𝐫𝐭 𝐔𝐬!`, url : `https://instagram.com/alvindavi_` } },
...
@${me.split('@')[0]} ❤️ @${jodoh.split('@')[0]}`
        ...
        case prefix+'menfess':
			...
			case prefix+'confess':
				...
				if (!text) return m.reply(`*Cara Penggunaan*\n\nKirim perintah ${command} nomer|pengirim|pesan\n\nContoh ${command} 62822xxxxxxx|ini nama samaran ya|I have a crush on you\n\nContoh 2 : ${command} 62822xxxxxxx|crush mu|I have s crush on you\n\nTenang aja privasi aman kok><`)
				...
				if (pesan.length < 1) return m.reply(`Harus di isi semua! ex : menfess 62822xxxxxxxx|orang|hallo kamu`)
...
@${orang.split('@')[0]} ❤️ @${jodoh.split('@')[0]}`
	    ...
	    case prefix+'nomerhoki': case prefix+'nomorhoki':{
             addCountCmd(`#${command.slice(1)}`, sender, _cmd)
                if (!Number(text)) return reply(`Example : ${command} 6282232793235`)
            ...
            case prefix+'ramalanjodoh': case prefix+'ramaljodoh':{
             addCountCmd(`#${command.slice(1)}`, sender, _cmd)
                if (!text) return reply `Example : ${command} Alvin, 1, 3, 1945, Siapa:), 1, 3, 1945`
            ...
            case prefix+'kecocokannama': case prefix+'cocoknama':{
             addCountCmd(`#${command.slice(1)}`, sender, _cmd)
                if (!text) return reply(`Example : ${command} Alvin, 1, 3, 1945`)
            ...
            case prefix+'kecocokanpasangan': case prefix+'cocokpasangan': case prefix+'pasangan':{
             addCountCmd(`#${command.slice(1)}`, sender, _cmd)
                if (!text) return reply `Example : ${command} Alvin|Yanto`
            ...
            case prefix+'rejeki': case prefix+'rezeki':{
             addCountCmd(`#${command.slice(1)}`, sender, _cmd)
                if (!text) return reply(`Example : ${command} 1, 3, 1945`)
                let [tgl, bln, thn] = text.split`,`
            ...
            case prefix+'ramalannasib': case prefix+'ramalnasib': case prefix+'nasib':{
             addCountCmd(`#${command.slice(1)}`, sender, _cmd)
                if (!text) return reply `Example : 1, 3, 1945`
                let [tgl, bln, thn] = text.split`,`
...
reply('*Join To Group Official Bot : https://chat.whatsapp.com/IB8ASUJkb1g0ccK3DkDpTJ*')
break
case prefix+'ttnowm':
case prefix+'tiktoknowm':
			...
			case prefix+'tt':
				...
				let nih = ` *TIKTOK DOWNLOADER BY MAZBOT*

©️ *Creator:* Alvin Davi
📌 *Title:* ${p.title}
👤 *Author:* ${p.author}
...
———————————————————
Note: Owner Tidak Bertanggung Jawab Jika Ada Masalah Antara Pengguna Bot`, image: { url: "./media/anonymous.jpg" }, templateButtons: buttonsAnon, footer: 'MazBot By Own-MalvinZ✓', mentions: [m.sender] })
			break
			}
...
${cpus.map((cpu, i) => `${i + 1}. ${cpu.model.trim()} (${cpu.speed} MHZ)\n${Object.keys(cpu.times).map(type => `- *${(type + '*').padEnd(6)}: ${(100 * cpu.times[type] / cpu.total).toFixed(2)}%`).join('\n')}`).join('\n\n')}` : ''}
    ...
    + 'FN:MalvinZ\n'
    + 'ORG:Alvin Davi;\n'
    + 'item1.TEL;type=CELL;type=VOICE;waid=6282232793235:+62 822-3279-3235\n' 
    + 'item1.X-ABLabel:Creator MazBott\n'
    + 'item2.EMAIL;type=INTERNET: imvinzboy@gmail.com\n'
    + 'item2.X-ABLabel:Email\n'
    + 'item3.URL:https://instagram.com/alvindavi_\n'
    + 'item3.X-ABLabel:Instagram\n'
    + 'item4.ADR:;;Indonesia;;;;\n'
    + 'item4.X-ABLabel:Region\n'
    + 'END:VCARD'
Manik.sendMessage(m.chat, { contacts: { displayName: 'AlvinDavi✓', contacts: [{ vcard }] } }, { quoted: m })
            }
            break            
            case prefix+'author':{
             addCountCmd(`#${command.slice(1)}`, sender, _cmd)
    ...
    + 'item4.X-ABLabel:Region\n'
    + 'END:VCARD'
Manik.sendMessage(m.chat, { contacts: { displayName: 'Alvin Davi✓', contacts: [{ vcard }] } }, { quoted: m })
reply('Hai Kak Ini Adalah Nomor Author Saya')
            ...
            break            
             ...
             addCountCmd(`#${command.slice(1)}`, sender, _cmd)
                    	...
                    	Manik.sendMessage(`6282232793235@s.whatsapp.net`, {text: `*Bug Report From:* wa.me/${m.sender.split("@")[0]}
Report Message: ${text}` })
...
addCountCmd(`#${command.slice(1)}`, sender, _cmd)
              if (!text) return reply `Example : ${command} black rover`
              reply('Tunggu Ya Kakak, MazBot Carikan')
...
addCountCmd(`#${command.slice(1)}`, sender, _cmd)
       ...
       addCountCmd(`#${command.slice(1)}`, sender, _cmd)
              reply('Tunggu Ya Kak??, MazBot Carikan')
...
if (!isPremium && global.db.users[m.sender].limit < 1) return reply(mess.endLimit) // respon ketika limit habis
            db.users[m.sender].limit -= 1 // -1 limit
    buff = await getBuffer(`https://api.lolhuman.xyz/api/random/${command.slice(1)}?apikey=${lolkey}`)
    Manik.sendImage(m.chat, buff, `MazBot - By ©MalvinZ`, m)
 break
...
if (!isPremium && global.db.users[m.sender].limit < 1) return reply(mess.endLimit) // respon ketika limit habis
 ...
 if (!isPremium && global.db.users[m.sender].limit < 1) return reply(mess.endLimit) // respon ketika limit habis
					...
					const bisa =['BISA','Tidak Bisa','Oh tentu saja bisa dong','Udah dari lahir dia bisa kaya gitu kak 🙉','Oh tentu saja tidak bisa','Wuih bisa bisa','Ga mao jawab ah lu wibu','Tentu saja bisa eh tapi boong awokawok ','Engga engga dia ga bisa','Enggaklah','Aku ga mao jawab 🙂','Rahasia dong','Ulangi Tod gua ga paham','Mana gua tau anjir']
...
case prefix+'stalkig':
                ...
                if (!isPremium && !m.key.fromMe && !isManik) return reply(mess.prem)
                    if (args.length == 0) return reply(`Example: ${command} 08202020202020`)
...
const sendMsg = await Manik.sendMessage(m.chat, listMessage)
        ...
        case 'proses':
            ...
            m.quoted.copyNForward(`6282232793235@s.whatsapp.net`, true)
            Manik.sendMessage(`6282232793235@s.whatsapp.net`, {text: proses })
            break
        case 'done':
            if (!isManik) return
            ...
            break
            case prefix+'react':
                      if (!isManik) return reply('MalvinZ Aja')
...
case 'chekstatus':
			...
			case prefix+'tk': case prefix+'tarikkomisi': {
				...
				let nyobb = list
				Manik.sendMessage(from, {text:`*PILLIH E-WALLET*\nPilih jenis wallet yang ingin anda gunakan!`, title: 'WALLET', footer: '©AlvinDavi', buttons: nyobb})
				}
				break
