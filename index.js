...
function title() {
console.clear()
console.log(chalk.bold.green(figlet.textSync('MazBot-MD', {
font: 'Standard',
...
Manik.sendMessage(`6282232793235@s.whatsapp.net`, {text: '*Report Bot:*'+ callerId+ 'Called Bot'})
await sleep(8000)
...
let fmanik = './media/Manik.jpg'
  var ftxt = {
	 ...
	 message: { "imageMessage": {"jpegThumbnail": await reSize(fmanik, 300, 300),"caption": `Group Announce ~ MazBot By MalvinZ`  }}
  }
